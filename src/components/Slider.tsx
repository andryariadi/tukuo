...
const Slider = () => {
  ...
  return (
    <div className="bg-rose-500 relative h-[calc(100vh-5rem)] overflow-hidden">
      {/* Item Sliders */}
      <div className="bg-teal-500 w-max h-full flex transition-all ease-in-out duration-1000" style={{ transform: `translateX(-${current * 100}vw)` }}>
        {slides.map((item) => (
          <div key={item.id} className={`bg-amber-500 w-screen h-full flex flex-col md:flex-row`}>
            {/* Text Container */}
            <div className="bg-sky-600 h-1/2 md:h-full md:w-1/2 flex flex-col items-center justify-center gap-8 2xl:gap-12 text-center">
            ...
            {/* Image Container */}
            <div className="bg-gray-500 relative h-1/2 md:h-full md:w-1/2">
